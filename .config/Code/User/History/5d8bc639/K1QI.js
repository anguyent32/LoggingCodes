...
playGameXTimes (['PAPER','ROCK','SCISSOR']) // calling playGameXTimes function, where it take in an arr (aka['PAPER','ROCK','SCISSOR']); this array get places as arr; so that is the same as saying: ['PAPER','ROCK','SCISSOR'].forEach(choice => checkWin(choice)) = arr.forEach( choice => checkWin(choice))
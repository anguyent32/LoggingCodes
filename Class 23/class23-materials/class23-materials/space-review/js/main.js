...
palindromeCheck('racecar')
        // the output will alert true/false
        // firtst str indicate: we take in a str
        // => arrow function
        // everything after => is the function of what we want it to do
    // we can do:
    // const palindromeCheck = str => alert( str === unoReverse(str))
    // BUT make sure that the : console.log taken out to set it as implicit return
    // let unoReverse = str.split('').reverse().join('')